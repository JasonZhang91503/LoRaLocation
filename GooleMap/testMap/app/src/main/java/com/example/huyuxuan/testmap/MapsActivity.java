package com.example.huyuxuan.testmap;
...
public class MapsActivity extends AppCompatActivity implements GoogleMap.OnMyLocationButtonClickListener, OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        locaBtn = (Button) findViewById(R.id.setPosiBtn);
        ...
        locaBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mLocation != null) {
                    ...
                    Toast.makeText(MapsActivity.this, R.string.no_location_detected, Toast.LENGTH_LONG).show();
                }
                mLocation = null;
            }
        });
