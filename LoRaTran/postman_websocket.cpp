        ...
        while(1){
            ...
            case 2:
                ...
                for (auto it : m_connections) {
                    ...
                    if((int)readBuff[1] == 0){ readBuff[1] = 1; }
                    if((int)readBuff[2] == 0){ readBuff[2] = 1; }
                    cout << "event num :" <<(int)readBuff[0] << ",x :" << (int)readBuff[1] << ",y :" << (int)readBuff[2] <<
                     ",dir :" << (int)readBuff[3] << ",sh :" << (int)readBuff[4] << endl;
